  ...
  return (
    <div className={cn('flex items-center justify-center gap-2 pt-8', className)}>
      <button
        ...
        className="flex h-10 w-10 items-center justify-center border border-[var(--color-line)] text-[var(--color-muted)] transition-colors hover:border-[var(--color-gold)] hover:text-[var(--color-gold)] disabled:cursor-not-allowed disabled:opacity-40"
      >
